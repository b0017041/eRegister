			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="student.courseNumber.label" default="Course Number" /></th>
					
						<g:sortableColumn property="learningCentreNo" title="${message(code: 'student.learningCentreNo.label', default: 'Learning Centre No')}" />
				...
				<g:each in="${studentInstanceList}" status="i" var="studentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${studentInstance.courseNumber.courseName}</td>
					
						<td>${fieldValue(bean: studentInstance, field: "learningCentreNo")}</td>
