	...
	<body>
		...
		<div id="show-regentry" class="content scaffold-show" role="main">
			...
			<ol class="property-list regentry">
				...
				<g:if test="${regentryInstance?.sheetNo}">
				<li class="fieldcontain">
					<span id="sheetNo-label" class="property-label"><g:message code="regentry.sheetNo.label" default="Sheet No" /></span>
					
						<span class="property-value" aria-labelledby="sheetNo-label"><g:link controller="regsheet" action="show" id="${regentryInstance?.sheetNo?.id}">${regentryInstance?.sheetNo?.encodeAsHTML()}</g:link></span>
