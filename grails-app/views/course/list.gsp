			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="course.courseLeader.label" default="Course Leader" /></th>
				...
				<g:each in="${courseInstanceList}" status="i" var="courseInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${courseInstance.id}">${fieldValue(bean: courseInstance, field: "courseNumber")}</g:link></td>
					
						<td>${courseInstance.courseLeader.staffName}</td>
